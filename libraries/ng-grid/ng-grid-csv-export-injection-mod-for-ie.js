    ...
    self.init = function(scope, grid, services) {
        ...
        function showDs() {
			...
			if (window.navigator.msSaveBlob) {
                //var e = angular.element("<span class=\"csv-data-link-span pull-right\"><button ng-click='exportIE()'>CSV Export</button></span>");
                var e = angular.element("<span class=\"csv-data-link-span pull-right\"><br><a href=\"#\" ng-click='exportIE()' class=\"btn btn-default btn-xs\" role=\"button\">CSV Export</a></br></span>");
                $compile(e)(scope);
                fp.append(e);
            }else{
